...
(function($) {
	...
	$.extend(MyAMS.i18n, {
		...
		BAD_LOGIN_MESSAGE: "Les paramètres de connexion que vous avez indiqués n'ont pas permis d'établir la connexion ; " +
			"veuillez vérifier ces paramètres, ou contactez un administrateur.",
		...
		HOME: "Accueil",
		LOGOUT: "Déconnexion ?",
		LOGOUT_COMMENT: "Vous pourrez améliorer votre sécurité en fermant cette fenêtre après vous être déconnecté.<br />Confirmez-vous la déconnexion ?",
